define(["@microsoft/sp-core-library","@microsoft/sp-webpart-base","@microsoft/sp-lodash-subset","@microsoft/sp-property-pane"], (__WEBPACK_EXTERNAL_MODULE__878__, __WEBPACK_EXTERNAL_MODULE__134__, __WEBPACK_EXTERNAL_MODULE__348__, __WEBPACK_EXTERNAL_MODULE__723__) => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
(() => {
/*!******************************************************************!*\
  !*** ./lib/webparts/myCallendarTeams/MyCallendarTeamsWebPart.js ***!
  \******************************************************************/
...
var MyCallendarTeamsWebPart = /** @class */ (function (_super) {
    ...
    MyCallendarTeamsWebPart.prototype._desenharGrade = function (cor) {
        ...
        var _loop_1 = function (dia) {
            ...
            html += "\n        <div class=\"dia-calendario\" data-data=\"".concat(dataFocoStr, "\" style=\"background: ").concat(eHoje ? '#f4f4fc' : '#fff', "; min-height: 110px; padding: 5px; border-right: 1px solid #edebe9; border-bottom: 1px solid #edebe9; cursor: pointer; box-sizing: border-box; overflow: hidden;\">\n          <div style=\"font-size: 12px; font-weight: ").concat(eHoje ? '700' : '400', "; color: ").concat(eHoje ? cor : '#323130', ";\">").concat(dia, "</div>\n          <div style=\"margin-top: 5px; display: flex; flex-direction: column; gap: 2px;\">\n            ").concat(evs.slice(0, 3).map(function (e) {
                ...
                var textoExibir = e.isFeriado ? (0,_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_2__.escape)(e.subject) : "".concat(hora, " ").concat((0,_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_2__.escape)(e.subject));
    ...
    MyCallendarTeamsWebPart.prototype._exibirDetalhes = function (data, cor) {
        ...
        if (painel && lista) {
            ...
            lista.innerHTML = "<h4 style=\"margin-top: 0; color: ".concat(cor, ";\">Eventos de ").concat((0,_microsoft_sp_lodash_subset__WEBPACK_IMPORTED_MODULE_2__.escape)(data), "</h4>");
                    ...
                    groups: [
                        {
                            groupName: "Cores",
                            groupFields: [
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneTextField)('corTema', {
    ...
    Object.defineProperty(MyCallendarTeamsWebPart.prototype, "dataVersion", {
        get: function () { return _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_0__.Version.parse('1.0'); },
        enumerable: false,
        configurable: true
    });
    return MyCallendarTeamsWebPart;
}(_microsoft_sp_webpart_base__WEBPACK_IMPORTED_MODULE_1__.BaseClientSideWebPart));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MyCallendarTeamsWebPart);
...
//# sourceMappingURL=my-callendar-teams-web-part.js.map