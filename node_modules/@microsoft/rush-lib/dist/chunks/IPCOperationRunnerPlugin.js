...
/* harmony export */ });
/* harmony import */ var node_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! node:events */ 315673);
...
/* harmony import */ var _OperationStatus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./OperationStatus */ 476597);
    ...
    async executeAsync(context) {
        return await context.runWithTerminalAsync(async (terminal, terminalProvider) => {
            ...
            if (!this._ipcProcess || typeof this._ipcProcess.exitCode === 'number') {
                ...
                this._ipcProcess = _utilities_Utilities__WEBPACK_IMPORTED_MODULE_3__.Utilities.executeLifecycleCommandAsync(this._shellCommand, {
...
/* harmony export */ });
/* harmony import */ var _IPCOperationRunner__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./IPCOperationRunner */ 371956);
/* harmony import */ var _OperationStatus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./OperationStatus */ 476597);
/* harmony import */ var _ShellOperationRunnerPlugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ShellOperationRunnerPlugin */ 658087);
// Copyright (c) Microsoft Corporation. All rights reserved. Licensed under the MIT license.
// See LICENSE in the project root for license information.
    ...
    apply(hooks) {
        ...
        hooks.createOperations.tapPromise({
            ...
            for (const operation of operations) {
                ...
                const commandToRun = (0,_ShellOperationRunnerPlugin__WEBPACK_IMPORTED_MODULE_0__.formatCommand)(rawScript, getCustomParameterValuesForPhase(phase));
