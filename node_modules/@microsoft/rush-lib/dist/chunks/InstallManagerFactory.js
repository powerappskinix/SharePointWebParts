...
class InstallManagerFactory {
    static async getInstallManagerAsync(rushConfiguration, rushGlobalFolder, purgeManager, options) {
        ...
        const rushInstallManagerModule = await Promise.all(/*! import() | RushInstallManager */[__webpack_require__.e("lib-esnext_logic_LinkManagerFactory_js"), __webpack_require__.e("RushInstallManager")]).then(__webpack_require__.bind(__webpack_require__, /*! ./installManager/RushInstallManager */ 108860));
...
/* harmony import */ var fs_promises__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! fs/promises */ 773292);
...
/* harmony import */ var _rushstack_terminal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @rushstack/terminal */ 569956);
...
/* harmony import */ var pnpm_sync_lib__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! pnpm-sync-lib */ 804988);
...
/* harmony import */ var _ApprovedPackagesChecker__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../ApprovedPackagesChecker */ 171208);
/* harmony import */ var _api_EnvironmentConfiguration__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../api/EnvironmentConfiguration */ 382806);
/* harmony import */ var _Git__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../Git */ 668229);
/* harmony import */ var _api_LastInstallFlag__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../api/LastInstallFlag */ 919846);
/* harmony import */ var _api_Rush__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../api/Rush */ 465002);
...
/* harmony import */ var _utilities_Utilities__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../utilities/Utilities */ 827501);
/* harmony import */ var _installManager_InstallHelpers__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../installManager/InstallHelpers */ 741340);
/* harmony import */ var _policy_PolicyValidator__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../policy/PolicyValidator */ 999291);
/* harmony import */ var _setup_SetupPackageRegistry__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../setup/SetupPackageRegistry */ 555992);
/* harmony import */ var _pnpm_PnpmfileConfiguration__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../pnpm/PnpmfileConfiguration */ 238032);
/* harmony import */ var _utilities_npmrcUtilities__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../utilities/npmrcUtilities */ 679877);
/* harmony import */ var _pnpm_SubspacePnpmfileConfiguration__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../pnpm/SubspacePnpmfileConfiguration */ 878898);
/* harmony import */ var _ProjectImpactGraphGenerator__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../ProjectImpactGraphGenerator */ 311000);
/* harmony import */ var _api_FlagFile__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../api/FlagFile */ 908574);
...
/* harmony import */ var _utilities_PnpmSyncUtilities__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../utilities/PnpmSyncUtilities */ 596422);
// Copyright (c) Microsoft Corporation. All rights reserved. Licensed under the MIT license.
// See LICENSE in the project root for license information.
...
class BaseInstallManager {
    ...
    async doInstallAsync() {
        ...
        if (resolutionOnly ||
            ...
            if (this.options.allowShrinkwrapUpdates && !shrinkwrapIsUpToDate) {
                ...
                const shrinkwrapFile = _ShrinkwrapFileFactory__WEBPACK_IMPORTED_MODULE_13__.ShrinkwrapFileFactory.getShrinkwrapFile(this.rushConfiguration.packageManager, this.rushConfiguration.packageManagerOptions, committedShrinkwrapFileName);
    ...
    async prepareAsync(subspace, variant, projectImpactGraphGenerator) {
        ...
        if (!this.options.fullUpgrade) {
            const committedShrinkwrapFileName = subspace.getCommittedShrinkwrapFilePath(variant);
            try {
                shrinkwrapFile = _ShrinkwrapFileFactory__WEBPACK_IMPORTED_MODULE_13__.ShrinkwrapFileFactory.getShrinkwrapFile(this.rushConfiguration.packageManager, this.rushConfiguration.packageManagerOptions, committedShrinkwrapFileName);
            }
            catch (ex) {
                terminal.writeLine();
...
`;
    ...
    pushConfigurationArgs(args, options, subspace) {
        ...
        if (this.rushConfiguration.packageManager === 'npm') {
            ...
            */
            const isAutoInstallPeersInNpmrc = (0,_utilities_npmrcUtilities__WEBPACK_IMPORTED_MODULE_24__.isVariableSetInNpmrcFile)(subspace.getSubspaceConfigFolderPath(), 'auto-install-peers');
            ...
            */
            const isResolutionModeInNpmrc = (0,_utilities_npmrcUtilities__WEBPACK_IMPORTED_MODULE_24__.isVariableSetInNpmrcFile)(subspace.getSubspaceConfigFolderPath(), 'resolution-mode');
    ...
    async _queryIfReleaseIsPublishedAsync(registryUrl) {
        ...
        const { WebClient } = await __webpack_require__.e(/*! import() */ "lib-esnext_utilities_WebClient_js").then(__webpack_require__.bind(__webpack_require__, /*! ../../utilities/WebClient */ 618105));
...
/* harmony import */ var _api_FlagFile__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../api/FlagFile */ 908574);
// Copyright (c) Microsoft Corporation. All rights reserved. Licensed under the MIT license.
// See LICENSE in the project root for license information.
...
/* harmony import */ var js_yaml__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! js-yaml */ 119793);
...
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! crypto */ 706113);
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(crypto__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _base_BaseInstallManager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../base/BaseInstallManager */ 876149);
...
/* harmony import */ var _pnpm_PnpmWorkspaceFile__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../pnpm/PnpmWorkspaceFile */ 688477);
...
/* harmony import */ var _ShrinkwrapFileFactory__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../ShrinkwrapFileFactory */ 819779);
/* harmony import */ var _base_BaseProjectShrinkwrapFile__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../base/BaseProjectShrinkwrapFile */ 894306);
/* harmony import */ var _api_CustomTipsConfiguration__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../api/CustomTipsConfiguration */ 268756);
/* harmony import */ var _utilities_objectUtilities__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../utilities/objectUtilities */ 569609);
...
/* harmony import */ var _base_BaseLinkManager__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../base/BaseLinkManager */ 826636);
/* harmony import */ var _api_FlagFile__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../api/FlagFile */ 908574);
...
class WorkspaceInstallManager extends _base_BaseInstallManager__WEBPACK_IMPORTED_MODULE_6__.BaseInstallManager {
    ...
    async prepareCommonTempAsync(subspace, shrinkwrapFile) {
            ...
            for (const { name, version, dependencyType } of [
                ...
                if ((dependencySpecifier.specifierType === _DependencySpecifier__WEBPACK_IMPORTED_MODULE_12__.DependencySpecifierType.Version ||
                    ...
                    if (!semver__WEBPACK_IMPORTED_MODULE_1__.satisfies(referencedLocalProject.packageJsonEditor.version, dependencySpecifier.versionSpecifier)) {
                        ...
                        console.log();
                        // eslint-disable-next-line no-console
                        console.log(_rushstack_terminal__WEBPACK_IMPORTED_MODULE_5__.Colorize.red(`"${rushProject.packageName}" depends on package "${name}" (${version}) which exists ` +
        ...
        const overridesAreEqual = (0,_utilities_objectUtilities__WEBPACK_IMPORTED_MODULE_13__.objectsAreDeepEqual)((_a = this.rushConfiguration.pnpmOptions.globalOverrides) !== null && _a !== void 0 ? _a : {}, (shrinkwrapFile === null || shrinkwrapFile === void 0 ? void 0 : shrinkwrapFile.overrides) ? Object.fromEntries(shrinkwrapFile === null || shrinkwrapFile === void 0 ? void 0 : shrinkwrapFile.overrides) : {});
        ...
        const packageExtensionsChecksum = this._getPackageExtensionChecksum(this.rushConfiguration.pnpmOptions.globalPackageExtensions);
        ...
        _InstallHelpers__WEBPACK_IMPORTED_MODULE_14__.InstallHelpers.generateCommonPackageJson(this.rushConfiguration, subspace, undefined);
    ...
    async postInstallAsync(subspace) {
        ...
        const tempShrinkwrapFile = _ShrinkwrapFileFactory__WEBPACK_IMPORTED_MODULE_17__.ShrinkwrapFileFactory.getShrinkwrapFile(this.rushConfiguration.packageManager, this.rushConfiguration.pnpmOptions, subspace.getTempShrinkwrapFilename());
