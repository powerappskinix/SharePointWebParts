...
class RushConfiguration {
     ...
     */
    getPnpmfilePath(subspace) {
        return (subspace !== null && subspace !== void 0 ? subspace : this.defaultSubspace).getPnpmfilePath();
    }
    /**
