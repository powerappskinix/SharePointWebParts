...
class Subspace {
    ...
    getPnpmOptions() {
        if (!this._cachedPnpmOptionsInitialized) {
            ...
            const subspaceConfigFolder = this.getSubspaceConfigFolderPath();
            const subspaceTempFolder = this.getSubspaceTempFolderPath();
            try {
                this._cachedPnpmOptions = PnpmOptionsConfiguration_1.PnpmOptionsConfiguration.loadFromJsonFileOrThrow(`${subspaceConfigFolder}/${RushConstants_1.RushConstants.pnpmConfigFilename}`, subspaceTempFolder);
