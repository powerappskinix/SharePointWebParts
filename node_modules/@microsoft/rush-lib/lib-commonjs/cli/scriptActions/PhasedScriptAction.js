...
const ParseParallelism_1 = require("../parsing/ParseParallelism");
const CobuildConfiguration_1 = require("../../api/CobuildConfiguration");
const CacheableOperationPlugin_1 = require("../../logic/operations/CacheableOperationPlugin");
const RushProjectConfiguration_1 = require("../../api/RushProjectConfiguration");
const LegacySkipPlugin_1 = require("../../logic/operations/LegacySkipPlugin");
const ValidateOperationsPlugin_1 = require("../../logic/operations/ValidateOperationsPlugin");
const ShardedPhaseOperationPlugin_1 = require("../../logic/operations/ShardedPhaseOperationPlugin");
const FlagFile_1 = require("../../api/FlagFile");
const WeightedOperationPlugin_1 = require("../../logic/operations/WeightedOperationPlugin");
/**
...
class PhasedScriptAction extends BaseScriptAction_1.BaseScriptAction {
    constructor(options) {
        ...
        this._watchDebounceMs = (_a = options.watchDebounceMs) !== null && _a !== void 0 ? _a : RushConstants_1.RushConstants.defaultWatchDebounceMs;
        ...
        const terminal = new terminal_1.Terminal(this.rushSession.terminalProvider);
        ...
        new ShardedPhaseOperationPlugin_1.ShardedPhasedOperationPlugin().apply(this.hooks);
        ...
        new WeightedOperationPlugin_1.WeightedOperationPlugin().apply(this.hooks);
        new ValidateOperationsPlugin_1.ValidateOperationsPlugin(terminal).apply(this.hooks);
    ...
    async runAsync() {
        ...
        if (this._alwaysInstall || ((_a = this._installParameter) === null || _a === void 0 ? void 0 : _a.value)) {
            ...
            await doBasicInstallAsync({
                ...
                beforeInstallAsync: (subspace) => this.rushSession.hooks.beforeInstall.promise(this, subspace, currentlyInstalledVariant),
                afterInstallAsync: (subspace) => this.rushSession.hooks.afterInstall.promise(this, subspace, currentlyInstalledVariant)
            });
        }
        if (!this._runsBeforeInstall) {
            // TODO: Replace with last-install.flag when "rush link" and "rush unlink" are removed
            const lastLinkFlag = new FlagFile_1.FlagFile(this.rushConfiguration.defaultSubspace.getSubspaceTempFolderPath(), RushConstants_1.RushConstants.lastLinkFlagFilename, {});
        ...
        const parallelism = this._enableParallelism
            ? (0, ParseParallelism_1.parseParallelism)((_b = this._parallelismParameter) === null || _b === void 0 ? void 0 : _b.value)
            : 1;
        ...
        if (showTimeline) {
            const { ConsoleTimelinePlugin } = await Promise.resolve().then(() => __importStar(require(
        ...
        if (!this._disableBuildCache) {
            ...
            cobuildConfiguration = await CobuildConfiguration_1.CobuildConfiguration.tryLoadAsync(terminal, this.rushConfiguration, this.rushSession);
        ...
        try {
            ...
            if (!projectSelection.size) {
                terminal.writeLine(terminal_1.Colorize.yellow(`The command line selection parameters did not match any projects.`));
                return;
            }
            const isWatch = ((_d = this._watchParameter) === null || _d === void 0 ? void 0 : _d.value) || this._alwaysWatch;
            if (isWatch && ((_e = this._noIPCParameter) === null || _e === void 0 ? void 0 : _e.value) === false) {
                new (await Promise.resolve().then(() => __importStar(require(
            ...
            if (buildCacheConfiguration === null || buildCacheConfiguration === void 0 ? void 0 : buildCacheConfiguration.buildCacheEnabled) {
                ...
                new CacheableOperationPlugin_1.CacheableOperationPlugin({
                ...
                new LegacySkipPlugin_1.LegacySkipPlugin({
                    allowWarningsInSuccessfulBuild: this.rushConfiguration.experimentsConfiguration.configuration
            ...
            const showBuildPlan = (_g = (_f = this._cobuildPlanParameter) === null || _f === void 0 ? void 0 : _f.value) !== null && _g !== void 0 ? _g : false;
            if (showBuildPlan) {
                if (!(buildCacheConfiguration === null || buildCacheConfiguration === void 0 ? void 0 : buildCacheConfiguration.buildCacheEnabled)) {
                    throw new Error('You must have build cache enabled to use this option.');
                }
                const { BuildPlanPlugin } = await Promise.resolve().then(() => __importStar(require('../../logic/operations/BuildPlanPlugin')));
                new BuildPlanPlugin(terminal).apply(this.hooks);
            }
            const { configuration: experiments } = this.rushConfiguration.experimentsConfiguration;
            if (((_h = this.rushConfiguration) === null || _h === void 0 ? void 0 : _h.packageManager) === 'pnpm' &&
                (experiments === null || experiments === void 0 ? void 0 : experiments.usePnpmSyncForInjectedDependencies)) {
                const { PnpmSyncCopyOperationPlugin } = await Promise.resolve().then(() => __importStar(require('../../logic/operations/PnpmSyncCopyOperationPlugin')));
                new PnpmSyncCopyOperationPlugin(terminal).apply(this.hooks);
            }
            const projectConfigurations = this
                ._runsBeforeInstall
                ? new Map()
                : await RushProjectConfiguration_1.RushProjectConfiguration.tryLoadForProjectsAsync(projectSelection, terminal);
    ...
    async _runInitialPhasesAsync(options) {
        ...
        const repoStateStopwatch = new Stopwatch_1.Stopwatch();
        ...
        terminal.writeLine();
        const initialExecuteOperationsContext = Object.assign(Object.assign({}, initialCreateOperationsContext), { projectChangeAnalyzer });
        ...
        return Object.assign(Object.assign({}, options), { executionManagerOptions, initialState: projectChangeAnalyzer });
    }
    ...
    async _runWatchPhasesAsync(options) {
        const { initialState, initialCreateOperationsContext, executionManagerOptions, stopwatch, terminal } = options;
        ...
        const { ProjectWatcher } = await Promise.resolve().then(() => __importStar(require(
        ...
        while (true) {
            ...
            for (const name of names) {
                terminal.writeLine(`    ${terminal_1.Colorize.cyan(name)}`);
            }
            // Account for consumer relationships
            const executeOperationsContext = Object.assign(Object.assign({}, initialCreateOperationsContext), { isInitial: false, projectChangeAnalyzer: state, projectsInUnknownState: changedProjects, phaseOriginal,
                phaseSelection,
                invalidateOperation });
    ...
    async _executeOperationsAsync(options) {
        ...
        try {
            ...
            if (result.status === OperationStatus_1.OperationStatus.Success) {
                terminal.writeLine(terminal_1.Colorize.green(message));
            }
            else {
            ...
            if (error instanceof node_core_library_1.AlreadyReportedError) {
                ...
                terminal.writeErrorLine(terminal_1.Colorize.red(`rush ${this.actionName} - Errors! (${stopwatch.toString()})`));
            }
        }
        if (!ignoreHooks) {
            this._doAfterTask();
