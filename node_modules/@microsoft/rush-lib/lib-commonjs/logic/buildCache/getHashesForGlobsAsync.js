...
exports.getHashesForGlobsAsync = void 0;
...
async function getHashesForGlobsAsync(globPatterns, packagePath, repoState) {
    ...
    if (!repoState) {
        return (0, package_deps_hash_1.getGitHashForFiles)(filePaths, packagePath);
    }
    const { foundPaths, missingPaths } = getKnownHashes(filePaths, packagePath, repoState);
    const calculatedHashes = (0, package_deps_hash_1.getGitHashForFiles)(missingPaths, packagePath);
    /**
...
exports.getHashesForGlobsAsync = getHashesForGlobsAsync;
