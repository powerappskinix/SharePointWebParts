...
class LegacySkipPlugin {
    ...
    apply(hooks) {
        ...
        hooks.beforeExecuteOperations.tapPromise(PLUGIN_NAME, async (operations, { projectChangeAnalyzer }) => {
            let logGitWarning = false;
            await node_core_library_1.Async.forEachAsync(operations.values(), async (record) => {
