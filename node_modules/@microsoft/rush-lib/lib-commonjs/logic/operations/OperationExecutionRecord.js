...
const OperationMetadataManager_1 = require("./OperationMetadataManager");
...
class OperationExecutionRecord {
    constructor(operation, context) {
        ...
        if (!runner) {
            throw new node_core_library_1.InternalError(`Operation for phase '${associatedPhase === null || associatedPhase === void 0 ? void 0 : associatedPhase.name}' and project '${associatedProject === null || associatedProject === void 0 ? void 0 : associatedProject.packageName}' has no runner.`);
        }
        ...
        this._operationMetadataManager =
            associatedPhase && associatedProject
                ? new OperationMetadataManager_1.OperationMetadataManager({
        ...
        this._status = operation.dependencies.size > 0 ? OperationStatus_1.OperationStatus.Waiting : OperationStatus_1.OperationStatus.Ready;
    }
    get name() {
    ...
    get isTerminal() {
        return OperationStatus_1.TERMINAL_STATUSES.has(this.status);
    }
    /**
    ...
    async runWithTerminalAsync(callback, options) {
        ...
        const logFilePaths = createLogFile && associatedProject && associatedPhase && this._operationMetadataManager
            ? (0, ProjectLogWritable_1.getProjectLogFilePaths)({
        ...
        const projectLogWritable = logFilePaths
            ? await (0, ProjectLogWritable_1.initializeProjectLogFilesAsync)({
                logFilePaths,
        ...
        try {
            ...
            const destination = projectLogWritable
                ? new terminal_1.SplitterTransform({
            ...
            const splitterTransform1 = new terminal_1.SplitterTransform({
                destinations: [
                    this.quietMode
                        ? new terminal_1.DiscardStdoutTransform({ destination: this.collatedWriter })
                        : this.collatedWriter,
                    stderrLineTransform
                ]
            });
