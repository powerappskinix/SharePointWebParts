...
exports.ShardedPhasedOperationPlugin = exports.PLUGIN_NAME = void 0;
const RushConstants_1 = require("../RushConstants");
const NullOperationRunner_1 = require("./NullOperationRunner");
const Operation_1 = require("./Operation");
const OperationStatus_1 = require("./OperationStatus");
const ShellOperationRunnerPlugin_1 = require("./ShellOperationRunnerPlugin");
exports.PLUGIN_NAME = 'ShardedPhasedOperationPlugin';
...
class ShardedPhasedOperationPlugin {
    apply(hooks) {
        hooks.createOperations.tap(exports.PLUGIN_NAME, spliceShards);
    }
}
exports.ShardedPhasedOperationPlugin = ShardedPhasedOperationPlugin;
function spliceShards(existingOperations, context) {
    var _a, _b, _c;
    const { rushConfiguration, projectConfigurations } = context;
    const getCustomParameterValuesForPhase = (0, ShellOperationRunnerPlugin_1.getCustomParameterValuesByPhase)();
    for (const operation of existingOperations) {
        ...
        if (phase && project && (operationSettings === null || operationSettings === void 0 ? void 0 : operationSettings.sharding) && !operation.runner) {
             ...
             * ```
             */
            const preShardOperation = new Operation_1.Operation({
                phase,
                project,
                settings: operationSettings,
                runner: new NullOperationRunner_1.NullOperationRunner({
                    name: `${(0, ShellOperationRunnerPlugin_1.getDisplayName)(phase, project)} - pre-shard`,
            ...
            const outputFolderArgumentFormat = (_a = operationSettings.sharding.outputFolderArgumentFormat) !== null && _a !== void 0 ? _a : `--shard-output-directory=${RushConstants_1.RushConstants.projectRushFolderName}/operations/${TemplateStrings.PHASE_NAME}/shards/${TemplateStrings.SHARD_INDEX}`;
            ...
            const collatorDisplayName = `${(0, ShellOperationRunnerPlugin_1.getDisplayName)(phase, project)} - collate`;
            ...
            const rawCommandToRun = (0, ShellOperationRunnerPlugin_1.getScriptToRun)(project, phase.name, phase.shellCommand);
            const commandToRun = rawCommandToRun
                ? (0, ShellOperationRunnerPlugin_1.formatCommand)(rawCommandToRun, collatorParameters)
                : undefined;
            operation.logFilenameIdentifier = `${baseLogFilenameIdentifier}_collate`;
            operation.runner = (0, ShellOperationRunnerPlugin_1.initializeShellOperationRunner)({
                phase,
                project,
            ...
            const baseCommand = (0, ShellOperationRunnerPlugin_1.getScriptToRun)(project, shardOperationName, undefined);
            ...
            const shardArgumentFormat = (_b = operationSettings.sharding.shardArgumentFormat) !== null && _b !== void 0 ? _b : `--shard=${TemplateStrings.SHARD_INDEX}/${TemplateStrings.SHARD_COUNT}`;
            ...
            for (let shard = 1; shard <= shards; shard++) {
                ...
                const shardOperationSettings = (_c = projectConfiguration === null || projectConfiguration === void 0 ? void 0 : projectConfiguration.operationSettingsByOperationName.get(shardOperationName)) !== null && _c !== void 0 ? _c : operationSettings.sharding.shardOperationSettings;
                const shardOperation = new Operation_1.Operation({
                    project,
                    phase,
                ...
                const shardDisplayName = `${(0, ShellOperationRunnerPlugin_1.getDisplayName)(phase, project)} - shard ${shard}/${shards}`;
                const shardedCommandToRun = baseCommand
                    ? (0, ShellOperationRunnerPlugin_1.formatCommand)(baseCommand, shardedParameters)
                    : undefined;
                shardOperation.runner = (0, ShellOperationRunnerPlugin_1.initializeShellOperationRunner)({
                    phase,
                    project,
