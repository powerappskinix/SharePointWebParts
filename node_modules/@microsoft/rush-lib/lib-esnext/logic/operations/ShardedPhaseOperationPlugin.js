...
import { formatCommand, getCustomParameterValuesByPhase, getDisplayName, getScriptToRun, initializeShellOperationRunner } from './ShellOperationRunnerPlugin';
...
function spliceShards(existingOperations, context) {
    ...
    for (const operation of existingOperations) {
        ...
        if (phase && project && (operationSettings === null || operationSettings === void 0 ? void 0 : operationSettings.sharding) && !operation.runner) {
            ...
            const baseCommand = getScriptToRun(project, shardOperationName, undefined);
