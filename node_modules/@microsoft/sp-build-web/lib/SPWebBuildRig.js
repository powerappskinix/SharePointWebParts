...
class SPWebBuildRig extends SPBuildRig_1.SPBuildRig {
    ...
    getTasks() {
        ...
        result.set(WebBuildRigConstants_1.WebBuildRigConstants.tasks.serve, {
            executable: (0, gulp_core_build_1.serial)(spBuildCoreTasks.serve, (0, gulp_core_build_1.watch)(exports.serveWatchFilter, (0, gulp_core_build_1.serial)(this._preTelemetryTask, 
            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
            result.get(WebBuildRigConstants_1.WebBuildRigConstants.tasks.bundle).executable, gulp_core_build_serve_1.reload, this._postTelemetryTask))),
            arguments: (yargs) => {
                return yargs
                    .option('port', {
