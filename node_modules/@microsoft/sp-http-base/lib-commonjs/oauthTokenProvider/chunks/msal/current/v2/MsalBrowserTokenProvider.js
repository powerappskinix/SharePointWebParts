...
var msal_browser_2_28_1_1 = require("@azure/msal-browser-2.28.1");
...
var MsalBrowserTokenProvider = /** @class */ (function () {
    ...
    MsalBrowserTokenProvider.prototype.getTokenData = function (resourceEndpoint, optionsOrUseCachedToken, skipLoggingAndDisableRedirects) {
        ...
        var requestContext = {
            ...
            resourceRequestMethod: options.resourceRequestMethod,
            shrClaims: options.shrClaims,
            shouldNotLogOrRedirect: shouldNotLogOrRedirect,
            telemetryData: this._generateTelemetryData(resourceEndpoint, options.authenticationScheme),
            useCachedToken: useCachedToken
        };
        if ((0, AadFlights_1.isPoPTokenFlightEnabled)() && options.authenticationScheme === ITokenProvider_1.IAuthenticationScheme.POP) {
            return this._getShrNonce(requestContext)
                .then(function (shrNonce) {
                requestContext.shrNonce = shrNonce;
                return _this._getTokenDataInternal(requestContext);
            })
                .catch(function (error) {
                return Promise.reject(error);
            });
        }
        return this._getTokenDataInternal(requestContext);
    };
    ...
    MsalBrowserTokenProvider.prototype._getShrNonce = function (requestContext) {
        var _this = this;
        var nonceMonitor = new MsalMonitor_1.MsalMonitor('MsalBrowserTokenProvider.GetShrNonce', requestContext.shouldNotLogOrRedirect);
    ...
    MsalBrowserTokenProvider.prototype._getTokenDataInternal = function (requestContext) {
        var _this = this;
        return this._ensureMsalClientIsInitialized(requestContext)
            ...
            var getTokenDataMonitor = new MsalMonitor_1.MsalMonitor('MsalBrowserTokenProvider.GetTokenData', requestContext.shouldNotLogOrRedirect);
            var tokenPromise;
            if (_this._isCurrentUserLoggedInToMsal()) {
                var acquireTokenSilentMonitor = new MsalMonitor_1.MsalMonitor('MsalBrowserTokenProvider.AcquireTokenSilent', requestContext.shouldNotLogOrRedirect);
                ...
                var ssoSilentMonitor = new MsalMonitor_1.MsalMonitor('MsalBrowserTokenProvider.SsoSilent', requestContext.shouldNotLogOrRedirect);
            ...
            return tokenPromise
                ...
                if (_this._isInteractionRequiredError(error)) {
                    var popupMonitor = new MsalMonitor_1.MsalMonitor('MsalBrowserTokenProvider.Popup', requestContext.shouldNotLogOrRedirect);
     ...
     */
    MsalBrowserTokenProvider.prototype._generateTelemetryData = function (resourceEndpoint, authenticationScheme) {
    ...
    MsalBrowserTokenProvider.prototype._isInteractionRequiredError = function (error) {
        return (error instanceof msal_browser_2_28_1_1.InteractionRequiredAuthError ||
     ...
     *
     * @param requestContext - The rquest context.
    ...
    MsalBrowserTokenProvider.prototype._getAuthenticationScheme = function (authenticationScheme) {
        ...
        if (authenticationScheme === ITokenProvider_1.IAuthenticationScheme.BEARER) {
            authScheme = msal_browser_2_28_1_1.AuthenticationScheme.BEARER;
        }
        else {
            authScheme = msal_browser_2_28_1_1.AuthenticationScheme.POP;
        }
        return authScheme;
    };
