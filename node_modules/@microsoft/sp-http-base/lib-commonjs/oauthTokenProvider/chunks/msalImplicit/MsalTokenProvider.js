...
var MsalTokenProvider = /** @class */ (function () {
    ...
    MsalTokenProvider.prototype.getTokenData = function (resourceEndpoint, optionsOrUseCachedToken, skipLoggingAndDisableRedirects) {
        ...
        var claims = options.claims, _a = options.useCachedToken, useCachedToken = _a === void 0 ? true : _a, _b = options.skipLoggingAndDisableRedirects, shouldNotLogOrRedirect = _b === void 0 ? false : _b;
    ...
    MsalTokenProvider.prototype.getTokenDataV2 = function (resourceEndpoint, options) {
        var _this = this;
        var _a = options.skipLoggingAndDisableRedirects, skipLoggingAndDisableRedirects = _a === void 0 ? false : _a, claims = options.claims;
        return MsalInteractionManager_1.MsalInteractionManager.acquireControl().then(function () {
            ...
            if (currentBrowser === sp_core_library_1._Browser.IE || currentBrowser === sp_core_library_1._Browser.Edge) {
                acquireTokenDataPromise = _this._loginSilent().then(function () {
                    return _this._acquireTokenData(resourceEndpoint, claims, skipLoggingAndDisableRedirects);
                });
            }
            else {
                acquireTokenDataPromise = _this._acquireTokenData(resourceEndpoint, claims, skipLoggingAndDisableRedirects);
            }
    ...
    MsalTokenProvider.prototype._ensureState = function () {
        return Promise.resolve();
    };
    MsalTokenProvider.prototype._ensureTelemetry = function () {
        return Promise.resolve();
    };
    ...
    MsalTokenProvider.prototype._acquireTokenData = function (resourceEndpoint, claims, skipLoggingAndDisableRedirects) {
        if (skipLoggingAndDisableRedirects === void 0) { skipLoggingAndDisableRedirects = false; }
        ...
        return this._acquireTokenDataHelper(resourceEndpoint, claims, 0, getAccessTokenQosMonitor);
    };
    MsalTokenProvider.prototype._acquireTokenDataHelper = function (resourceEndpoint, claims, attempt, getAccessTokenQosMonitor, useLoginHint) {
        var _this = this;
        ...
        var extraData = this._generateTelemetryExtraData();
        var requestData = tslib_1.__assign({ authority: this._defaultConfiguration.aadInstanceUrl + '/' + this._defaultConfiguration.aadTenantId, correlationId: extraData.CorrelationId, loginHint: this._defaultConfiguration.userPrincipalName, scopes: [resourceEndpoint + '/.default'] }, (claims
            ? {
        ...
        return this._msalInstance
            ...
            if ((AadErrorHandler_1.AadErrorHandler._isTokenRenewalTimeout(e.errorCode) && attempt < 1) ||
                ...
                return _this._acquireTokenDataHelper(resourceEndpoint, claims, ++attempt, getAccessTokenQosMonitor);
            }
                ...
                attempt < 1) {
                return _this._acquireTokenDataHelper(resourceEndpoint, claims, ++attempt, getAccessTokenQosMonitor, true);
            }
            else {
                if (getAccessTokenQosMonitor) {
                    if (!(0, AadKillSwitches_1.isMsalImplicitV1TokenByPopupKSActivated)() &&
    ...
    MsalTokenProvider.prototype._initializeMsalJs = function () {
        ...
        if (MsalUtilities_1.MsalUtilities.shouldPrintMsalLogsToConsole()) {
            configuration.system.logger = new msalLegacy_1.Logger(MsalUtilities_1.MsalUtilities.msalLoggerCallback, {
        ...
        if (sp_core_library_1._SPFlight.isEnabled(467) /* Allow MSAL to prompt the end user for MFA errors */ &&
            ...
            if (attemptNumber < this._allowedRedirectAttempts) {
                ...
                var onRedirectNavigate = function (url) {
                    ...
                    if ((0, AadFlights_1.isMsalBrowserV3FlightEnabled)() && !_this._redirectCancelled) {
                        window.sessionStorage.setItem('spfx.msalv1.override', 'true');
                    }
    ...
    /**
     * Acquires a token by the popup flow
     * @see https://learn.microsoft.com/en-us/azure/active-directory/develop/scenario-spa-acquire-token?tabs=javascript2#acquire-a-token-with-a-pop-up-window
     *
     * @returns
     */
