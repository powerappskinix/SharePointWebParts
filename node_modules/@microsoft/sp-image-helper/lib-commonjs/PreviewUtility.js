...
exports.PreviewUtility = exports.EMPTY_GUIDS = exports.CACHE_BREAKPOINT_S = exports.PUBLIC_CACHE_BREAKPOINT_S = exports.MAX_PIXEL_RATIO = void 0;
...
var PreviewUtility = /** @class */ (function () {
     ...
     */
    PreviewUtility.getAlternateUrl = function (resourcePath, width, height, originalWidth, originalHeight, cropMode, viewportTop, viewportLeft, viewportWidth, viewportHeight, cacheBuster) {
     ...
     */
    PreviewUtility.getVROOMThumbnailUrl = function (vroomItemUrl, width, height, cacheBuster, resolution, originalWidth, originalHeight, cropMode, viewportTop, viewportLeft, viewportWidth, viewportHeight, format) {
        ...
        if (vroomItemUrl) {
            ...
            var urlPreferNoRedirect = "".concat(vroomItemUrl, "/thumbnails/0/c").concat(finalWidth, "x").concat(finalHeight, "/content?").concat(PreviewUtility.PREFER, "=").concat(PreviewUtility.NO_REDIRECT, ",").concat(PreviewUtility.EXTEND_CACHE_MAXAGE, "&").concat(PreviewUtility.CLIENT_TYPE, "=").concat(PreviewUtility.MODERN_WEB_PART).concat(viewportParams).concat(cropModeParams).concat(originalWidthHeightParams).concat(cacheBusterParam).concat(formatParam);
