...
var Thumbnail_1 = require("@ms/odsp-datasources/lib/Thumbnail");
    ...
    _ThumbnailUrlGenerator.prototype.getVROOMThumbnailUrl = function (request, provider) {
        ...
        if ((isAspx ||
            ...
            if (isCroppingRequest || isCropModeSpecified) {
                return PreviewUtility_1.PreviewUtility.getVROOMThumbnailUrl(vroomUrl, request.width, request.height, request.cacheBuster, undefined, request.originalWidth, request.originalHeight, request.cropMode, request.viewportTop, request.viewportLeft, request.viewportWidth, request.viewportHeight);
            }
            else {
