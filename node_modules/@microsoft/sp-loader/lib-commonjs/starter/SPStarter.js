...
var SPStarter = /** @class */ (function () {
    ...
    SPStarter.start = function (preloadedData, handleFailure, debugData, isFirstFlush) {
        ...
        return DebugManager_1.DebugManager.initializeAsync(componentLoader, debugData)
            ...
            if (debugLoadResult.debugLoader) {
                // To prevent double logging in debug sessions, we dispose the older telemetry instance
    ...
    SPStarter.initializeFlightsAndKillswitches = function (spPageContextInfo) {
        ...
        if (!this._isKillSwitchAndFlightingInitialized) {
            ...
            sp_core_library_1._ECSFlight.initialize(spPageContextInfo === null || spPageContextInfo === void 0 ? void 0 : spPageContextInfo.ECSExpFeatures);
    ...
    SPStarter._initializeTelemetry = function (preloadedData) {
        ...
        sp_telemetry_1._Telemetry.initialize(workload, spPageContextInfo, buildNumber, clientSideApplicationId);
    ...
    /**
     * @deprecated - To check whether telemetry is uploading, use _Telemetry.shouldLogEvents().
     */
    SPStarter._isTelemetryDisabled = function () {
        if (!sp_core_library_1._SPKillSwitch.isActivated('a670a259-9efb-4990-987d-62deb679ae63' /* '02/27/2024', 'Remove isTelemetryDisabled from SPStarter' */)) {
            return false;
        }
        return (SPStarter._isQueryParameterTrue('disableTelemetry') ||
            ...
            !sp_telemetry_1._Telemetry.shouldLogEvents());
    };
