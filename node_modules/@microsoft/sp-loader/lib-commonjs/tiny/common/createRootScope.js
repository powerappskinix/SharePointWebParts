...
function getThirdPartyToken(servicePrincipalId, aadTokenProvider, firstPartyConfiguration) {
    return aadTokenProvider._getTokenInternal(servicePrincipalId, firstPartyConfiguration);
}
function initializeGraphHttpClient(pageContext, spHttpClient, graphContext) {
    ...
    if ((0, flights_1.isNaaFlightEnabled)() && sp_core_library_1._BrowserUtilities.isTeamsHosted()) {
