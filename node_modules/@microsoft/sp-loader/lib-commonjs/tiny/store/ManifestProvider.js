...
var ManifestProvider = /** @class */ (function () {
    ...
    ManifestProvider.prototype.fetchManifests = function (requests) {
        ...
        return this._httpClient
            .post("".concat((this._pageContext.web && this._pageContext.web.absoluteUrl) || this._webAbsoluteUrl, "/_api/web/GetClientSideComponents"), sp_http_base_1.SPHttpClient.configurations.v1, {
            ...
            extraData.fromServiceWorker = response.headers.get('X-From-Service-Worker') === 'true';
