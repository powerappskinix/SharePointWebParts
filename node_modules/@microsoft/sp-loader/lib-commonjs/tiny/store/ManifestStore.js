        ...
        if (storeEntry) {
            ...
            if (!version) {
                ...
                if (!manifest) {
                    ...
                    var error = new Error("Cannot find manifest for ".concat(id, "_").concat(version, ". Store had [").concat(storeVersions_1.join(', '), "]. Service worker version: ").concat(stats ? stats.version : window.__spfxMark ? '(unknown)' : '(none)').concat(!(0, killSwitches_1.isAppVersionKillSwitchActivated)()
                        ? "; App version: ".concat(stats ? stats.appVersion : '(unknown)', "; Next app version: ").concat(stats ? stats.nextAppVersion : '(unknown)')
                        : ''));
