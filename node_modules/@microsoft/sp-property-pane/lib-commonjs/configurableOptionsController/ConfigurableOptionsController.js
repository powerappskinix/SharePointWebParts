...
var ConfigurableOptionsController = /** @class */ (function () {
    function ConfigurableOptionsController() {
        ...
        this._onContentPanelUpdate = function () {
            sp_diagnostics_1._TraceLogger.logVerbose(logSource, "Content panel updated externally");
            // Conflict resolution:
        ...
        if ((0, Flights_1.isConfigurationToolsEnabled)()) {
            var qosMonitor_1 = new sp_diagnostics_1._QosMonitor((0, sp_pages_content_panel_context_1.getQOSName)(COMPONENT_NAME, sp_pages_content_panel_context_1.SPPagesContentPanelQOSScenarios.loadChunk, 'updateListener'));
            this._contentPanelController = new DeferredContentPanelController_1.DeferredContentPanelController();
            this._contentPanelController.waitForController().then(function () {
                var _a;
                qosMonitor_1.writeSuccess();
                return (_a = _this._contentPanelController) === null || _a === void 0 ? void 0 : _a.addOnUpdateListener(_this._onContentPanelUpdate);
            }, function (error) {
                qosMonitor_1.writeUnexpectedFailure(error);
    ...
    ConfigurableOptionsController.prototype.registerConsumer = function (instanceId, consumer) {
        ...
        var qosMonitor = new sp_diagnostics_1._QosMonitor((0, sp_pages_content_panel_context_1.getQOSName)(COMPONENT_NAME, sp_pages_content_panel_context_1.SPPagesContentPanelQOSScenarios.rendering, 'registerConsumer'));
        this._registerConsumerPromise || (this._registerConsumerPromise = this._contentPanelController.waitForController());
        this._registerConsumerPromise = this._registerConsumerPromise.then(function () {
            ...
            sp_diagnostics_1._TraceLogger.logError(logSource, customError);
            _this._propertyPaneController.registerConsumer(instanceId, consumer);
            qosMonitor.writeUnexpectedFailure(undefined, customError);
        });
    };
    ...
    ConfigurableOptionsController.prototype.requestAction = function (toBeConfiguredConsumerId, propertyPaneAction, renderedByWebPart, context) {
        ...
        var qosMonitor = new sp_diagnostics_1._QosMonitor((0, sp_pages_content_panel_context_1.getQOSName)(COMPONENT_NAME, sp_pages_content_panel_context_1.SPPagesContentPanelQOSScenarios.rendering, 'requestAction'));
        this._registerConsumerPromise || (this._registerConsumerPromise = this._contentPanelController.waitForController());
        this._registerConsumerPromise.then(function () {
    ...
    ConfigurableOptionsController.prototype._isContentPanelComponent = function (instanceId, consumer) {
        ...
        sp_diagnostics_1._TraceLogger.logVerbose(logSource, "Content Panel supports '".concat(instanceId, "'? ").concat(isSupported, " (isConsumerDefined: ").concat(!!consumer, ", isControllerDefined: ").concat(!!this
            ._contentPanelControllerCasted, ")"));
        return isSupported;
    };
