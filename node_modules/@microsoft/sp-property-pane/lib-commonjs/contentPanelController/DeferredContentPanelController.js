...
var DCPC = /** @class */ (function () {
    function DCPC() {
        ...
        if ((0, Flights_1.isConfigurationToolsEnabled)() && !DCPC._contentPanelControllerPromise) {
            var qosMonitor_1 = new sp_diagnostics_1._QosMonitor((0, sp_pages_content_panel_context_1.getQOSName)(logSource_1.COMPONENT_NAME, sp_pages_content_panel_context_1.SPPagesContentPanelQOSScenarios.loadChunk));
            DCPC._contentPanelControllerPromise = Promise.resolve().then(function () { return tslib_1.__importStar(require(
            /* webpackChunkName: 'ContentPanelController' */ './ContentPanelController')); }).then(function (module) {
                ...
                qosMonitor_1.writeUnexpectedFailure('UnhandledError', error);
                throw error;
            })
