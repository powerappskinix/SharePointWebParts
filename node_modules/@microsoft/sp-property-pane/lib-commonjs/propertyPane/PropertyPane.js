...
var PropertyPane = /** @class */ (function (_super) {
    ...
    PropertyPane.prototype._renderPage = function (hideTitleBar) {
        ...
        return (React.createElement("div", null,
            ...
            !customFooter && (React.createElement(PropertyPaneFooter_1.default, { isReactive: this.props.data.isReactive || false, isSaveButtonEnabled: this.state.isSaveButtonEnabled, numberOfPages: this.props.data.configuration &&
