 ...
 * @internal
 */
function PropertyPaneAlternativeText(properties) {
    return tslib_1.__spreadArray(tslib_1.__spreadArray([], (properties.disableHeading
        ? []
        : [
...
function getPropertyPaneToggleProperties(isDecorative, moduleName, dataAutomationId, controlName) {
    return tslib_1.__assign({ inlineLabel: true, onAriaLabel: Strings_resx_1.default.OnAriaLabel, offAriaLabel: Strings_resx_1.default.OffAriaLabel, dataAutomationId: dataAutomationId, checked: isDecorative, _label: getToggleLabel() }, {
