...
var ClientSideWebPartManager = /** @class */ (function () {
            ...
            return (this._loadAndInitWebPart(context_1)
                ...
                if ('isDisposed' in e) {
                    ...
                    if ((errorWebPart === null || errorWebPart === void 0 ? void 0 : errorWebPart.modifiedByGraph) &&
                        !(0, KillSwitches_1.isGraphMetadataPropertyKSActivated)() &&
                        (0, Flights_1.shouldShowGraphMetadataInErrorMessage)()) {
    ...
    ClientSideWebPartManager.prototype.setWebPartData = function (context, instanceId, shouldFallback) {
        ...
        if (wp && webPartData) {
            if (shouldFallback) {
                ...
                wp._internalSetWebPartData(webPartData, context.addedFromPersistedData);
                    ...
                    if (webPartThumbnail) {
                        ...
                        if (webPartThumbnail.length < THUMBNAIL_MAX_URL_LENGTH) {
                            ...
                            if (isSupportedByOAuth ||
                                (!(0, KillSwitches_1.isFixPageThumbnailKSActivated)() && _this._isTitleAreaBannerWebPart(webPart))) {
    ...
    ClientSideWebPartManager.prototype._fetchManifestsWithCache = function (httpClient, requestUrl) {
        if (!ClientSideWebPartManager._manifestRequestPromiseCache[requestUrl]) {
            ClientSideWebPartManager._manifestRequestPromiseCache[requestUrl] = httpClient.post(requestUrl, sp_http_1.SPHttpClient.configurations.v1, tslib_1.__assign({ body: JSON.stringify({
                    project: sp_core_library_1.Session.clientSideApplicationId
                }) }, (!(0, KillSwitches_1.isVersionHeaderKillSwitchActivated)() && {
                headers: {
    ...
    ClientSideWebPartManager.prototype._isTitleAreaBannerWebPart = function (webPart) {
        var _a, _b;
        if ((0, KillSwitches_1.isFixPageThumbnailKSActivated)() || !(0, Flights_1.isOptionalTitleRegionEnabled)()) {
            return false;
        }
