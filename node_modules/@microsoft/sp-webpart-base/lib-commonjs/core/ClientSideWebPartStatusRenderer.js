...
var ClientSideWebPartStatusRenderer = /** @class */ (function () {
    ...
    ClientSideWebPartStatusRenderer.prototype._renderError = function (domElement, error, options) {
        ...
        if (error instanceof sp_core_library_1.SPError) {
            ...
            if (!(0, KillSwitches_1.isGraphMetadataPropertyKSActivated)()) {
            ...
            var callStack = stack
                ...
                : '';
            if ((0, KillSwitches_1.isGraphMetadataPropertyKSActivated)()) {
                errorText = sp_core_library_1.Text.format(Strings_resx_1.default.WebpartErrorErrorText, newLineSeparator, "".concat(vanillaError.message || error), callStack, '');
            }
            else {
