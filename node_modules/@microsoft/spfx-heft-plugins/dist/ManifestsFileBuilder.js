...
function buildManifestsJs(options) {
    return __awaiter(this, void 0, void 0, function () {
        var manifestsArray, outputFilePath, azurePathOverride, manifestsJsFileMetadata, stripOutIntegrities, formattedManifests, outputFileName, filledTemplate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    manifestsArray = options.manifestsArray, outputFilePath = options.outputFilePath, azurePathOverride = options.azurePathOverride, manifestsJsFileMetadata = options.manifestsJsFileMetadata, stripOutIntegrities = options.stripOutIntegrities;
                    formattedManifests = JSON.stringify(manifestsArray, getManifestCompressor(stripOutIntegrities));
