...
function readAssetFiles(terminal, assetFilePaths, assetFileDescription, subdir) {
    return ((assetFilePaths === null || assetFilePaths === void 0 ? void 0 : assetFilePaths.map((filepath) => {
        let contents;
        ...
        terminal.writeLine(terminal_1.Colorize.cyan(`Found ${assetFileDescription}: ${filename}`));
        return {
