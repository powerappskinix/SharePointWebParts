...
async function writePackageAsync(terminal, solution, config, noSpppkg) {
    ...
    await Promise.all([
        ...
        .concat(
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    solution.customFiles.map((customFile) => writeXmlFileAsync(terminal, customFile, config, zip)))
...
async function writeFeatureAsync(terminal, feature, config, zip) {
    await Promise.all([
        ...
        .concat(
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    feature.assets.elementFiles.map((asset) => writeXmlFileAsync(terminal, asset, config, zip)))
        .concat(
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    feature.assets.elementManifests.map((asset) => writeXmlFileAsync(terminal, asset, config, zip)))
        .concat(
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    feature.assets.upgradeActions.map((asset) => writeXmlFileAsync(terminal, asset, config, zip)))
