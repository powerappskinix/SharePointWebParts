...
class WebpackConfigurationPlugin {
    ...
    async _loadConfigJsonAsync(heftConfiguration, scopedLogger, allowMissingConfigJson) {
        ...
        const configResult = await (0, configJsonReader_1.readConfigFileAsync)(scopedLogger.terminal.writeVerboseLine.bind(scopedLogger.terminal), configFilePath);
        ...
        if (!configResult.isLatestVersion && !configResult.missingFile) {
            (0, configJsonMigrator_1.migrateToLatestVersion)(scopedLogger.terminal.writeWarningLine.bind(scopedLogger.terminal), 
            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
            configResult.configData);
            await node_core_library_1.JsonFile.saveAsync(configResult.configData, configFilePath, { prettyFormatting: true });
