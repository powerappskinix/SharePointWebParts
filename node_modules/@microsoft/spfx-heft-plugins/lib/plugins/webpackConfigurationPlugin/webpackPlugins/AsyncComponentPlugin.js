...
exports.AsyncComponentPlugin = exports.isExternalModule = exports.CHUNK_COMPONENT_MAP = void 0;
    ...
    apply(compiler) {
        ...
        compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
            ...
            compilation.hooks.afterOptimizeChunkModules.tap(PLUGIN_NAME, (baseChunks, modules) => {
                    ...
                    if (isExternalModule(module)) {
                        ...
                        if (externalComponent) {
                            ...
                            if (externalComponent.componentName === SPFX_LOADER_COMPONENT_NAME) {
                                ...
                                for (const originModule of moduleGraph
                ...
                if (!spfxLoaderModule) {
                    spfxLoaderModule = new ExternalModule(SPFX_LOADER_COMPONENT_NAME, (_a = compiler.options.output.library) === null || _a === void 0 ? void 0 : _a.type, SPFX_LOADER_COMPONENT_NAME);
            ...
            compilation.mainTemplate.hooks.requireEnsure.tap(PLUGIN_NAME, (existingRequireEnsure, baseChunk) => {
                ...
                return Template.asString([existingRequireEnsure, ...extraCode]);
            });
            // TODO: Replace this with webpack's `RuntimeModule`
            compilation.mainTemplate.hooks.localVars.tap(PLUGIN_NAME, (existing, baseRuntimeChunk) => {
                ...
                if (chunkComponentMap.size === 0) {
                    ...
                    return Template.asString([existing, ...extraCode]);
                }
            });
            // TODO: Replace this with webpack's `RuntimeModule`
            compilation.mainTemplate.hooks.requireExtensions.tap(PLUGIN_NAME, (existing, baseRuntimeChunk) => {
                ...
                if (spfxLoaderModule) {
                    spfxLoaderModuleId = compilation.chunkGraph.getModuleId(spfxLoaderModule);
                }
                else {
