...
function migrateToLatestVersion(logWarning, configJson) {
    const bundleNameRegexString = Object.keys(config_2_0_schema_json_1.default.properties.bundles.patternProperties)[0];
