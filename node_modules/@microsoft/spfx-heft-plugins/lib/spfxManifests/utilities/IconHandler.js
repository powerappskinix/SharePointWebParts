...
})(IconPathType || (exports.IconPathType = IconPathType = {}));
/**
 * @internal
 */
class IconHandler {
        ...
        switch (iconPathType) {
            case IconPathType.RelativePath: {
                ...
                if (!node_core_library_1.FileSystem.exists(iconAbsolutePath)) {
                    ...
                    const hash = (0, getFullHash_1.getFullHash)(iconContent, compilation.outputOptions.hashSalt);
            ...
            case IconPathType.RelativeUrl: {
                compilation.warnings.push(new WebpackError(`The icon path "${iconPath}" appears to be a relative web URL. This means that when the ` +
