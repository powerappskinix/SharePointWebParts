...
exports.VariableNameGenerator = void 0;
...
class VariableNameGenerator {
    static async initializeAsync() {
        if (!VariableNameGenerator._javascriptReservedWords) {
            ...
            VariableNameGenerator._javascriptReservedWords = new Set(await node_core_library_1.JsonFile.loadAsync(`${__dirname}/javascriptReservedWords.json`));
        }
...
exports.VariableNameGenerator = VariableNameGenerator;
